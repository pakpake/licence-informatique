...
let tableau = [ aj(10,[]) ; aj(10,[]) ; aj(10,[]) ; aj(10,[]) ; aj(10,[]) ; aj(10,[]) ; aj(10,[]) ;[15;15;15;15;15;15;15;15;15;15] ;[15;15;15;15;15;15;15;15;15;15] ;[15;15;15;15;15;15;15;15;15;15] ];;
...
let rec place(l,i,val,couleur)= if i=0 then [val]@tl(l) else [hd(l)]@place(tl(l),i-1,val,couleur);;
let rec donne_0(l,i)= if i=0 then hd(l) else donne_0(tl(l),i-1);;
let donne_1(l,i,j)= donne_0(donne_0(l,i),j);;
let rec descente(l,i,j,couleur) = if donne_1(l,i-1,j)=15 then descente(l,i-1,j,couleur) else place(l,i-1,j,couleur);;
