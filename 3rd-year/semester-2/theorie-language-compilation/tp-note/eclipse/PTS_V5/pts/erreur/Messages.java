...
public enum Messages {
  ...
  TYPE_FOR_INIT("la constante d'initialisation du for n'est pas un entier ligne %d"), // TODO: for
  TYPE_FOR_LAST("l'expression de fin du for n'est pas une entier ligne %d"), // TODO: for
  ;
