 ...
 ********************************************/
  ...
  final public Noeud BreakIfStatement() throws ParseException {
    Noeud n1;
    jj_consume_token(BREAKIF);
    n1 = Expression();
      if (niveau_iteration == 0) {
        Erreur.compilation(Messages.INVALID_BREAKIF,getToken(0).beginLine);
     }
     {if (true) return new Noeud(getToken(0).beginLine,EtiquetteNoeud.BREAKIF_STATEMENT,n1);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x400,0x0,0x400,0x0,0x4,0x0,0x800,0x0,0x0,0x0,0x5,0x400,0x5,0x5,0x4,0x400046,0x0,0x800,0x1f8000,0x1f8000,0x600000,0x600000,0x3800000,0x3800000,0x400046,0x400046,0x0,};
   }
