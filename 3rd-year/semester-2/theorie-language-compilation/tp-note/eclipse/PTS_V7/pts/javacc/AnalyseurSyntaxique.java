 ...
 ********************************************/
  ...
  final public Noeud CaseStatement() throws ParseException {
    Noeud n1,n2,n3,n4,n5=null;
    ...
    n5 = Statement();
    jj_consume_token(END);
        {if (true) return new Noeud(getToken(0).beginLine,EtiquetteNoeud.CASE_STATEMENT, new Noeud[] {n1,n2,n3,n4,n5});}
    throw new Error("Missing return statement in function");
  }
