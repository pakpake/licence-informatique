...
// supprimer son compte = supprimer le compte de l'abonné actuellement connecté 
public class SupprimerCompte {
    /*** A changer, quand on saura gérer des sessions en java ***/
    static String numSecu="100334433333315";    // celui d'un abonné (par exemple)
        /* numéro à remplacer par celui de la personne actuellement connecté :
         * soit un abonné
         * soit un bibliothécaire */
    ...
    public static boolean connexSuppressIon(Connection c, String numero, String pass) {
        ...
        try {
            ...
            // ****** TEST POUR UN NUMERO SPECIFIC *******numero="321";
