...
// **** TODO: idem pour le mot de passe , interdire certrain caractères spéciaux 
...
/* AUTRE CHOSE - dans le else
            // on arête le processus d'inscription et on revient à l'accueil
            System.out.println("\nVous allez être redigé à l'accueil du logiciel ...");
            System.out.println("Ne touchez à rien pendant ce laps de temps");
            // redirection vers Main.java
            Main.realMain();
*/
    }catch(SQLException e) { System.err.println(e.getMessage()); }
    // return true si g>0
...
// méthode d'affichage des données lues auparavant
...
public static void insertValues(Connection c) {
    try {
        ...
        // insertion des valeurs dans la bdd Librairie dans la table Abonnes
        // statement.executeUpdate("insert into Abonnes values('012345678901234', 'ThisIsLeNom', 'CestLePrenom', '01/02/1970', '10/20/2020', 'Pseudo', 'MotDePasse', '0')");
